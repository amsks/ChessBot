...
Edit finger1{ joint:transX Q:<> A:<t(+.02 0 -.05)> limits: [-.04 0.025], contact: -2, shape:ssBox, size:[.005, .02, .06, .002] }
Edit finger2{ joint:transX mimic:(finger1) Q:<> A:<d(180 0 0 1) t(+.02 0 -.05)>, contact: -2, shape:ssBox, size:[.005, .02, .06, .002]}
